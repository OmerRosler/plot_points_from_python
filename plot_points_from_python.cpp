...
struct reader_state_machine
{
    ...
    void set_pixel_of_point(double x, double y)
    {
        ...
        //The formula is the inverse of the one used to convert the index to the point in `run_algorithm_per_pixel`
